...
class WeeklyEventFactory extends Factory
{
    ...
    {
        return $this->state(fn (array $attributes) => ['is_active' => true, 'starts_at' => now()->subDay(), 'ends_at' => now()->addWeek()]);
    }

    public function upcoming(): static
    {
        return $this->state(fn (array $attributes) => ['is_active' => true, 'starts_at' => now()->addWeek(), 'ends_at' => now()->addWeeks(2)]);
    }
}
