...
return new class() extends Migration
{
    public function up(): void
    {
        ...
        $guard('users', function (Blueprint $table) {
            $table->id();
            $table->string('name');
        ...
        $guard('password_reset_tokens', function (Blueprint $table) {
            $table->string('email')->primary();
            $table->string('token');
            $table->timestamp('created_at')->nullable();
        });
        $guard('sessions', function (Blueprint $table) {
        ...
        $guard('personal_access_tokens', function (Blueprint $table) {
            $table->id();
        ...
        $guard('tournaments', function (Blueprint $table) {
            ...
            $table->bigInteger('entry_fee_minor')->default(0);
            $table->bigInteger('prize_pool_minor')->default(0);
        ...
        $guard('wallets', function (Blueprint $table) {
            $table->id();
        ...
        $guard('ledger_entries', function (Blueprint $table) {
            $table->id();
        ...
        $guard('idempotency_records', function (Blueprint $table) {
        ...
        $guard('cache', function (Blueprint $table) {
            $table->string('key')->primary();
            $table->mediumText('value');
            $table->integer('expiration');
        });
        $guard('cache_locks', function (Blueprint $table) {
            $table->string('key')->primary();
            $table->string('owner');
            $table->integer('expiration');
        });
        $guard('jobs', function (Blueprint $table) {
            $table->id();
        ...
        $guard('job_batches', function (Blueprint $table) {
            $table->string('id')->primary();
            $table->string('name');
        ...
        $guard('failed_jobs', function (Blueprint $table) {
            $table->id();
