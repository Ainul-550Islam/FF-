@extends('layouts.app')
@section('title', 'Reconciliation Report 10 - Financial Totals Must Reconcile')
@section('content')
<div class="container" style="max-width: 1000px; margin: 0 auto; padding: 24px;">
<h1 style="font-size: 28px; font-weight: 800;">📊 Reconciliation Report 10 - G1 Constraint</h1>
<p style="color: var(--text-muted);">Financial totals MUST reconcile, if differences STOP, do not declare complete - Gold wallets gem wallets transactions - Report 10</p>
<div class="card" style="padding: 20px; margin-top: 20px;">
<h3>Gold Wallet Reconciliation 10</h3>
...
<div class="card" style="padding: 20px; margin-top: 20px;">
<h3>Gem Wallet Reconciliation 10</h3>
<div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 12px; margin-top: 12px;">
