...
<h3>Gameberry Features Checklist 426</h3>
...
<h3>Dice Collection 426</h3>
<div style="font-size: 12px; color: var(--text-muted);">Owned {{ ['owned'] ?? 0 }}/250 types | {{ ['percent'] ?? 0 }}% complete | Max 52 per type | Facebook exchange</div>
