...
@section('title', 'Gameberry Feature 327 - Core Production 121-400')
...
<div class="container" style="max-width: 1280px; margin: 0 auto; padding: 24px;">
    ...
    <div class="card" style="padding: 16px; margin-top: 20px;">
        <h3>Gap Closure Checklist 327</h3>
    ...
    <div class="card" style="padding: 16px; margin-top: 20px;">
        <h3>Feature 327 Metadata</h3>
        <div style="font-size: 12px; color: var(--text-muted); line-height: 1.7;">
            Calculation: value * 327 + user_id = 32700<br>
            Part: Part 3 File 312-361<br>
            Description: {{ $stats['description'] ?? 'Gameberry gap closure feature 327' }}<br>
