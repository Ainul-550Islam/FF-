...
class UserPolicy
{
    ...
    /**
     * Legacy helper kept for the pre-Phase14 screens: a viewer may see a
     * target's account page when it is their own or the viewer is staff.
     */
    public function view(User $auth, User $target): bool
    {
        return $auth->id === $target->id || $auth->isStaff();
    }

    /**
     * Legacy helper kept for the pre-Phase14 screens: self or admin may edit.
     */
