...
class TeamUpMatch extends Model
{
    ...
    public function teamAUser1()
    {
        return $this->belongsTo(User::class, 'team_a_user1_id');
    }

    public function teamAUser2()
    {
        return $this->belongsTo(User::class, 'team_a_user2_id');
    }

    public function teamBUser1()
    {
        return $this->belongsTo(User::class, 'team_b_user1_id');
    }

    public function teamBUser2()
    {
        return $this->belongsTo(User::class, 'team_b_user2_id');
    }
