...
class PlayerStats extends Model
{
    ...
    public function winRate(): float { if ($this->total_games===0) return 0; return round(($this->wins/$this->total_games)*100,2); }
    public function addWin(int $goldWon = 0, int $gemsEarned = 0): void
    {
        $this->total_games += 1; $this->wins += 1; $this->win_streak += 1; $this->best_win_streak = max($this->best_win_streak, $this->win_streak); $this->total_gold_won += $goldWon; $this->total_gems_earned += $gemsEarned; $this->save();
    }
    public function addLoss(int $goldLost = 0): void
    {
        $this->total_games += 1; $this->losses += 1; $this->win_streak = 0; $this->total_gold_lost += $goldLost; $this->save();
    }
}
