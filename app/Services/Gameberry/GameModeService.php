...
class GameModeService
{
    ...
    public function getMaxPlayers(string $mode): int
    {
        return self::MODES[$mode]['max_players'] ?? 4;
    }
    ...
    public function isValidVariation(string $variation): bool
    {
        return in_array($variation, self::VARIATIONS);
    }
    ...
    public function getGoldMultiplier(string $mode): float
    {
        return $this->getMode($mode)['gold_multiplier'] ?? 1;
    }
}
