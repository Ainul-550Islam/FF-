...
class LevelService
{
    ...
    public function canAccessBronze(int $userId): bool
    {
        return $this->getOrCreateLevel($userId)->level >= self::LEVEL_4_BRONZE;
    }

    public function canAccessTitan(int $userId): bool
    {
        return $this->getOrCreateLevel($userId)->level >= self::LEVEL_12_TITAN;
    }
