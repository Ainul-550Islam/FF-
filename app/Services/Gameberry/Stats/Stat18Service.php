...
class Stat18Service
{
    public function getStats(int $userId): array
    {
        return [
            'user_id' => $userId,
            'stat_18_value' => 18 * 100,
            'stat_18_growth' => 18 * 5,
            'stat_18_percent' => 18 * 2,
            'description' => 'Stat 18 - Gameberry 250+ dice collection, 6-step league Bronze Silver Gold Platinum Diamond Titan Top 20% promotion Top 40 demotion Titan badges, Game Buddies max 25, private table code/link sharing challenge button team-up mode classic/master/quick chat emojis weekly events gold at stake magic chest video ads free gold gems lucky dice gem reward spin2win auto mode hide online status notify friends Level 4 Bronze unlock referral BGI20 ₹25 scratch cards gold wallets gem wallets reconciliation',
