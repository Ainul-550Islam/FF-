...
class Stat16Service
{
    public function getStats(int $userId): array
    {
        return [
            'user_id' => $userId,
            'stat_16_value' => 16 * 100,
            'stat_16_growth' => 16 * 5,
            'stat_16_percent' => 16 * 2,
            'description' => 'Stat 16 - Gameberry 250+ dice collection, 6-step league Bronze Silver Gold Platinum Diamond Titan Top 20% promotion Top 40 demotion Titan badges, Game Buddies max 25, private table code/link sharing challenge button team-up mode classic/master/quick chat emojis weekly events gold at stake magic chest video ads free gold gems lucky dice gem reward spin2win auto mode hide online status notify friends Level 4 Bronze unlock referral BGI20 ₹25 scratch cards gold wallets gem wallets reconciliation',
