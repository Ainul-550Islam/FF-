    ...
    public function getTrophiesForResult(bool $isWin, string $gameMode = 'classic'): int
    {
        if ($isWin) {
            return match ($gameMode) {
                'quick' => self::TROPHY_WIN_QUICK, 'classic' => self::TROPHY_WIN_CLASSIC, 'master' => self::TROPHY_WIN_MASTER, 'team_up' => self::TROPHY_WIN_CLASSIC, default => self::TROPHY_WIN_CLASSIC
            };
        } else {
            return match ($gameMode) {
                'quick' => self::TROPHY_LOSS_QUICK, 'classic' => self::TROPHY_LOSS_CLASSIC, 'master' => self::TROPHY_LOSS_MASTER, 'team_up' => self::TROPHY_LOSS_CLASSIC, default => self::TROPHY_LOSS_CLASSIC
            };
        }
    }
