...
class RustFraudServiceAdapter
{
    public function evaluate(array $data): array
    {
        ...
        try {
            ...
            $response = Http::withHeaders(['Authorization' => 'Bearer '.config('services_go_rust.rust_security.token'), 'X-Request-ID' => Str::uuid()])->timeout(config('services_go_rust.rust_security.timeout', 5))->post($url, $data);
