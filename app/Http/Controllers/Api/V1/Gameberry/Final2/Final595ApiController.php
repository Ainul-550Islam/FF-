...
use App\Services\Gameberry\Final2\Final595Service;
use Illuminate\Http\Request;
class Final595ApiController extends Controller
{
    protected Final595Service $service;
    public function __construct(Final595Service $service) { $this->service = $service; }
