...
use App\Services\Gameberry\Final2\Final588Service;
use Illuminate\Http\Request;
class Final588ApiController extends Controller
{
    protected Final588Service $service;
    public function __construct(Final588Service $service) { $this->service = $service; }
