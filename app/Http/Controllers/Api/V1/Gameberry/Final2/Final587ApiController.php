...
use App\Services\Gameberry\Final2\Final587Service;
use Illuminate\Http\Request;
class Final587ApiController extends Controller
{
    protected Final587Service $service;
    public function __construct(Final587Service $service) { $this->service = $service; }
