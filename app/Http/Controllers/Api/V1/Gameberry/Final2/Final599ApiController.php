...
use App\Services\Gameberry\Final2\Final599Service;
use Illuminate\Http\Request;
class Final599ApiController extends Controller
{
    protected Final599Service $service;
    public function __construct(Final599Service $service) { $this->service = $service; }
