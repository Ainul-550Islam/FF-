...
use App\Services\Gameberry\Final2\Final597Service;
use Illuminate\Http\Request;
class Final597ApiController extends Controller
{
    protected Final597Service $service;
    public function __construct(Final597Service $service) { $this->service = $service; }
