...
use App\Services\Gameberry\Final2\Final586Service;
use Illuminate\Http\Request;
class Final586ApiController extends Controller
{
    protected Final586Service $service;
    public function __construct(Final586Service $service) { $this->service = $service; }
