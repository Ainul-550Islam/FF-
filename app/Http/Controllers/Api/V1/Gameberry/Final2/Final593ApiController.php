...
use App\Services\Gameberry\Final2\Final593Service;
use Illuminate\Http\Request;
class Final593ApiController extends Controller
{
    protected Final593Service $service;
    public function __construct(Final593Service $service) { $this->service = $service; }
