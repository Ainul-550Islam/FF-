...
use App\Services\Gameberry\Final2\Final589Service;
use Illuminate\Http\Request;
class Final589ApiController extends Controller
{
    protected Final589Service $service;
    public function __construct(Final589Service $service) { $this->service = $service; }
