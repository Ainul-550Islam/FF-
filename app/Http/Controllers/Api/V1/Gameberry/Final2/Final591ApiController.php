...
use App\Services\Gameberry\Final2\Final591Service;
use Illuminate\Http\Request;
class Final591ApiController extends Controller
{
    protected Final591Service $service;
    public function __construct(Final591Service $service) { $this->service = $service; }
