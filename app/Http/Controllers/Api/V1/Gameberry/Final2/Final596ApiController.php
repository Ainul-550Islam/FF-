...
use App\Services\Gameberry\Final2\Final596Service;
use Illuminate\Http\Request;
class Final596ApiController extends Controller
{
    protected Final596Service $service;
    public function __construct(Final596Service $service) { $this->service = $service; }
