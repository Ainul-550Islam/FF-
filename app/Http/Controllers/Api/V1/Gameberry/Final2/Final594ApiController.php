...
use App\Services\Gameberry\Final2\Final594Service;
use Illuminate\Http\Request;
class Final594ApiController extends Controller
{
    protected Final594Service $service;
    public function __construct(Final594Service $service) { $this->service = $service; }
