...
use App\Services\Gameberry\Final2\Final590Service;
use Illuminate\Http\Request;
class Final590ApiController extends Controller
{
    protected Final590Service $service;
    public function __construct(Final590Service $service) { $this->service = $service; }
