...
use App\Services\Gameberry\Final2\Final600Service;
use Illuminate\Http\Request;
class Final600ApiController extends Controller
{
    protected Final600Service $service;
    public function __construct(Final600Service $service) { $this->service = $service; }
