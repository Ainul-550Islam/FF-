...
use App\Services\Gameberry\Final2\Final592Service;
use Illuminate\Http\Request;
class Final592ApiController extends Controller
{
    protected Final592Service $service;
    public function __construct(Final592Service $service) { $this->service = $service; }
