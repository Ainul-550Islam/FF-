...
class Final1090ApiController extends Controller
{
    protected $service;

    public function __construct()
    {
        $serviceClass = 'App\\Services\\Gameberry\\Final7\\Final1055Service';
    ...
    public function play(Request $request)
    {
        ...
        try {
            ...
            return response()->json([
                'success' => true,
                'data' => $result,
                'message' => 'Final7 1090 result: ' . ($result['is_win'] ? 'win' : 'loss') . ' - Gold at stake, magic chest, Level 4 Bronze unlock, reconciliation must hold STOP if mismatch G1 - Full file content no shortening',
                'feature' => 1090,
                'production_ready' => true,
                'no_shortening' => true,
            ]);
            ...
            return response()->json([
                'success' => false,
                'message' => 'Final1090 play failed: ' . $e->getMessage() . ' - G1 Must Reconcile STOP',
                'feature' => 1090,
            ], 400);
        }
    }
