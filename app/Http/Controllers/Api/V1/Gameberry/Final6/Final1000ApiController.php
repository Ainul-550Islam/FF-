...
use App\Services\Gameberry\Final6\Final1000Service;
use Illuminate\Http\Request;
class Final1000ApiController extends Controller
{
    protected Final1000Service $service;
    public function __construct(Final1000Service $service) { $this->service = $service; }
