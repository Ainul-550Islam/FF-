...
use App\Services\Gameberry\Final6\Final993Service;
use Illuminate\Http\Request;
class Final993ApiController extends Controller
{
    protected Final993Service $service;
    public function __construct(Final993Service $service) { $this->service = $service; }
