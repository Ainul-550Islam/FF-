...
use App\Services\Gameberry\Final6\Final997Service;
use Illuminate\Http\Request;
class Final997ApiController extends Controller
{
    protected Final997Service $service;
    public function __construct(Final997Service $service) { $this->service = $service; }
