...
use App\Services\Gameberry\Final6\Final990Service;
use Illuminate\Http\Request;
class Final990ApiController extends Controller
{
    protected Final990Service $service;
    public function __construct(Final990Service $service) { $this->service = $service; }
