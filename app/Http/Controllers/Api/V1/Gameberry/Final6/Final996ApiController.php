...
use App\Services\Gameberry\Final6\Final996Service;
use Illuminate\Http\Request;
class Final996ApiController extends Controller
{
    protected Final996Service $service;
    public function __construct(Final996Service $service) { $this->service = $service; }
