...
use App\Services\Gameberry\Final6\Final986Service;
use Illuminate\Http\Request;
class Final986ApiController extends Controller
{
    protected Final986Service $service;
    public function __construct(Final986Service $service) { $this->service = $service; }
