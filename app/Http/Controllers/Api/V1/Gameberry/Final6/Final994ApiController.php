...
use App\Services\Gameberry\Final6\Final994Service;
use Illuminate\Http\Request;
class Final994ApiController extends Controller
{
    protected Final994Service $service;
    public function __construct(Final994Service $service) { $this->service = $service; }
