...
use App\Services\Gameberry\Final6\Final998Service;
use Illuminate\Http\Request;
class Final998ApiController extends Controller
{
    protected Final998Service $service;
    public function __construct(Final998Service $service) { $this->service = $service; }
