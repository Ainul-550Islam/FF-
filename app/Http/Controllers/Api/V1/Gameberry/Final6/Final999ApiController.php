...
use App\Services\Gameberry\Final6\Final999Service;
use Illuminate\Http\Request;
class Final999ApiController extends Controller
{
    protected Final999Service $service;
    public function __construct(Final999Service $service) { $this->service = $service; }
