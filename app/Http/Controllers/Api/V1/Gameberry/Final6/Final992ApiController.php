...
use App\Services\Gameberry\Final6\Final992Service;
use Illuminate\Http\Request;
class Final992ApiController extends Controller
{
    protected Final992Service $service;
    public function __construct(Final992Service $service) { $this->service = $service; }
