...
use App\Services\Gameberry\Final6\Final987Service;
use Illuminate\Http\Request;
class Final987ApiController extends Controller
{
    protected Final987Service $service;
    public function __construct(Final987Service $service) { $this->service = $service; }
