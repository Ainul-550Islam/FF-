...
use App\Services\Gameberry\Final6\Final989Service;
use Illuminate\Http\Request;
class Final989ApiController extends Controller
{
    protected Final989Service $service;
    public function __construct(Final989Service $service) { $this->service = $service; }
