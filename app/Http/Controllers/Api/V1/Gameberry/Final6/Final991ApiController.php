...
use App\Services\Gameberry\Final6\Final991Service;
use Illuminate\Http\Request;
class Final991ApiController extends Controller
{
    protected Final991Service $service;
    public function __construct(Final991Service $service) { $this->service = $service; }
