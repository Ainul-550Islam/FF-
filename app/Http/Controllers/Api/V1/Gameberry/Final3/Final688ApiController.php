...
use App\Services\Gameberry\Final3\Final688Service;
use Illuminate\Http\Request;
class Final688ApiController extends Controller
{
    protected Final688Service $service;
    public function __construct(Final688Service $service) { $this->service = $service; }
