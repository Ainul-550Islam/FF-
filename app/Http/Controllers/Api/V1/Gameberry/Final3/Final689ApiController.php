...
use App\Services\Gameberry\Final3\Final689Service;
use Illuminate\Http\Request;
class Final689ApiController extends Controller
{
    protected Final689Service $service;
    public function __construct(Final689Service $service) { $this->service = $service; }
