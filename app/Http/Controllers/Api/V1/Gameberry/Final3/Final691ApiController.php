...
use App\Services\Gameberry\Final3\Final691Service;
use Illuminate\Http\Request;
class Final691ApiController extends Controller
{
    protected Final691Service $service;
    public function __construct(Final691Service $service) { $this->service = $service; }
