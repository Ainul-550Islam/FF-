...
use App\Services\Gameberry\Final3\Final693Service;
use Illuminate\Http\Request;
class Final693ApiController extends Controller
{
    protected Final693Service $service;
    public function __construct(Final693Service $service) { $this->service = $service; }
