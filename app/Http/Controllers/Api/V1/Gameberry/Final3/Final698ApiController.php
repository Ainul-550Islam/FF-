...
use App\Services\Gameberry\Final3\Final698Service;
use Illuminate\Http\Request;
class Final698ApiController extends Controller
{
    protected Final698Service $service;
    public function __construct(Final698Service $service) { $this->service = $service; }
