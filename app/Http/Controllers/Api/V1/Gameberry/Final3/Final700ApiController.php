...
use App\Services\Gameberry\Final3\Final700Service;
use Illuminate\Http\Request;
class Final700ApiController extends Controller
{
    protected Final700Service $service;
    public function __construct(Final700Service $service) { $this->service = $service; }
