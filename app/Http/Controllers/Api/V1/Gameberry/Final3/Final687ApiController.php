...
use App\Services\Gameberry\Final3\Final687Service;
use Illuminate\Http\Request;
class Final687ApiController extends Controller
{
    protected Final687Service $service;
    public function __construct(Final687Service $service) { $this->service = $service; }
