...
use App\Services\Gameberry\Final3\Final690Service;
use Illuminate\Http\Request;
class Final690ApiController extends Controller
{
    protected Final690Service $service;
    public function __construct(Final690Service $service) { $this->service = $service; }
