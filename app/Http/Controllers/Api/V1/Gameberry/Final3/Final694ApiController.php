...
use App\Services\Gameberry\Final3\Final694Service;
use Illuminate\Http\Request;
class Final694ApiController extends Controller
{
    protected Final694Service $service;
    public function __construct(Final694Service $service) { $this->service = $service; }
