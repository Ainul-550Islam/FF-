...
use App\Services\Gameberry\Final3\Final697Service;
use Illuminate\Http\Request;
class Final697ApiController extends Controller
{
    protected Final697Service $service;
    public function __construct(Final697Service $service) { $this->service = $service; }
