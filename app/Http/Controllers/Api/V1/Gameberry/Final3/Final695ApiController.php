...
use App\Services\Gameberry\Final3\Final695Service;
use Illuminate\Http\Request;
class Final695ApiController extends Controller
{
    protected Final695Service $service;
    public function __construct(Final695Service $service) { $this->service = $service; }
