...
use App\Services\Gameberry\Final3\Final686Service;
use Illuminate\Http\Request;
class Final686ApiController extends Controller
{
    protected Final686Service $service;
    public function __construct(Final686Service $service) { $this->service = $service; }
