...
use App\Services\Gameberry\Final3\Final692Service;
use Illuminate\Http\Request;
class Final692ApiController extends Controller
{
    protected Final692Service $service;
    public function __construct(Final692Service $service) { $this->service = $service; }
