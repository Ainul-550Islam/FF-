...
use App\Services\Gameberry\Final3\Final696Service;
use Illuminate\Http\Request;
class Final696ApiController extends Controller
{
    protected Final696Service $service;
    public function __construct(Final696Service $service) { $this->service = $service; }
