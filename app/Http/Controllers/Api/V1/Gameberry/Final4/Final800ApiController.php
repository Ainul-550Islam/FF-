...
use App\Services\Gameberry\Final4\Final800Service;
use Illuminate\Http\Request;
class Final800ApiController extends Controller
{
    protected Final800Service $service;
    public function __construct(Final800Service $service) { $this->service = $service; }
