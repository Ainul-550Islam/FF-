...
use App\Services\Gameberry\Final4\Final795Service;
use Illuminate\Http\Request;
class Final795ApiController extends Controller
{
    protected Final795Service $service;
    public function __construct(Final795Service $service) { $this->service = $service; }
