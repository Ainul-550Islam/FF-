...
use App\Services\Gameberry\Final4\Final787Service;
use Illuminate\Http\Request;
class Final787ApiController extends Controller
{
    protected Final787Service $service;
    public function __construct(Final787Service $service) { $this->service = $service; }
