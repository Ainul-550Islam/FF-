...
use App\Services\Gameberry\Final4\Final799Service;
use Illuminate\Http\Request;
class Final799ApiController extends Controller
{
    protected Final799Service $service;
    public function __construct(Final799Service $service) { $this->service = $service; }
