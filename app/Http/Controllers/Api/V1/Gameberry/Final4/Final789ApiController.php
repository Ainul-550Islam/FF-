...
use App\Services\Gameberry\Final4\Final789Service;
use Illuminate\Http\Request;
class Final789ApiController extends Controller
{
    protected Final789Service $service;
    public function __construct(Final789Service $service) { $this->service = $service; }
