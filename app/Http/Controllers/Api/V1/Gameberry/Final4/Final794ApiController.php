...
use App\Services\Gameberry\Final4\Final794Service;
use Illuminate\Http\Request;
class Final794ApiController extends Controller
{
    protected Final794Service $service;
    public function __construct(Final794Service $service) { $this->service = $service; }
