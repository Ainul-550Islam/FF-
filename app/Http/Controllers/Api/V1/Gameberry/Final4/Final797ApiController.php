...
use App\Services\Gameberry\Final4\Final797Service;
use Illuminate\Http\Request;
class Final797ApiController extends Controller
{
    protected Final797Service $service;
    public function __construct(Final797Service $service) { $this->service = $service; }
