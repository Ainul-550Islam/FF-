...
use App\Services\Gameberry\Final4\Final798Service;
use Illuminate\Http\Request;
class Final798ApiController extends Controller
{
    protected Final798Service $service;
    public function __construct(Final798Service $service) { $this->service = $service; }
