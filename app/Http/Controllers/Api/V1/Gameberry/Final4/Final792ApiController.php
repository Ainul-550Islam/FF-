...
use App\Services\Gameberry\Final4\Final792Service;
use Illuminate\Http\Request;
class Final792ApiController extends Controller
{
    protected Final792Service $service;
    public function __construct(Final792Service $service) { $this->service = $service; }
