...
use App\Services\Gameberry\Final4\Final793Service;
use Illuminate\Http\Request;
class Final793ApiController extends Controller
{
    protected Final793Service $service;
    public function __construct(Final793Service $service) { $this->service = $service; }
