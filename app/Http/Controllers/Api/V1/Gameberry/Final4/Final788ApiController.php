...
use App\Services\Gameberry\Final4\Final788Service;
use Illuminate\Http\Request;
class Final788ApiController extends Controller
{
    protected Final788Service $service;
    public function __construct(Final788Service $service) { $this->service = $service; }
