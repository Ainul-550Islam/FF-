...
use App\Services\Gameberry\Final4\Final791Service;
use Illuminate\Http\Request;
class Final791ApiController extends Controller
{
    protected Final791Service $service;
    public function __construct(Final791Service $service) { $this->service = $service; }
