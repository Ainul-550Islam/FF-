...
use App\Services\Gameberry\Final4\Final796Service;
use Illuminate\Http\Request;
class Final796ApiController extends Controller
{
    protected Final796Service $service;
    public function __construct(Final796Service $service) { $this->service = $service; }
