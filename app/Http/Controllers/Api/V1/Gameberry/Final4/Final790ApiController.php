...
use App\Services\Gameberry\Final4\Final790Service;
use Illuminate\Http\Request;
class Final790ApiController extends Controller
{
    protected Final790Service $service;
    public function __construct(Final790Service $service) { $this->service = $service; }
