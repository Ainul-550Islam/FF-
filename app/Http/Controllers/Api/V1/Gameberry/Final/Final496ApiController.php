...
use App\Services\Gameberry\Final\Final496Service;
use Illuminate\Http\Request;
class Final496ApiController extends Controller
{
    protected Final496Service $service;
    public function __construct(Final496Service $service) { $this->service = $service; }
