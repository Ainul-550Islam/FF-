...
use App\Services\Gameberry\Final\Final489Service;
use Illuminate\Http\Request;
class Final489ApiController extends Controller
{
    protected Final489Service $service;
    public function __construct(Final489Service $service) { $this->service = $service; }
