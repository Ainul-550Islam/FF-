...
use App\Services\Gameberry\Final\Final487Service;
use Illuminate\Http\Request;
class Final487ApiController extends Controller
{
    protected Final487Service $service;
    public function __construct(Final487Service $service) { $this->service = $service; }
