...
use App\Services\Gameberry\Final\Final488Service;
use Illuminate\Http\Request;
class Final488ApiController extends Controller
{
    protected Final488Service $service;
    public function __construct(Final488Service $service) { $this->service = $service; }
