...
use App\Services\Gameberry\Final\Final492Service;
use Illuminate\Http\Request;
class Final492ApiController extends Controller
{
    protected Final492Service $service;
    public function __construct(Final492Service $service) { $this->service = $service; }
