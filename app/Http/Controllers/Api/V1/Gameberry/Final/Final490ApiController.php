...
use App\Services\Gameberry\Final\Final490Service;
use Illuminate\Http\Request;
class Final490ApiController extends Controller
{
    protected Final490Service $service;
    public function __construct(Final490Service $service) { $this->service = $service; }
