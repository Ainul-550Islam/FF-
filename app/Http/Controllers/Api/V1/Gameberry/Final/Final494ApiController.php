...
use App\Services\Gameberry\Final\Final494Service;
use Illuminate\Http\Request;
class Final494ApiController extends Controller
{
    protected Final494Service $service;
    public function __construct(Final494Service $service) { $this->service = $service; }
