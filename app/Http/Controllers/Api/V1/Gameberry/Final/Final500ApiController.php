...
use App\Services\Gameberry\Final\Final500Service;
use Illuminate\Http\Request;
class Final500ApiController extends Controller
{
    protected Final500Service $service;
    public function __construct(Final500Service $service) { $this->service = $service; }
