...
use App\Services\Gameberry\Final\Final486Service;
use Illuminate\Http\Request;
class Final486ApiController extends Controller
{
    protected Final486Service $service;
    public function __construct(Final486Service $service) { $this->service = $service; }
