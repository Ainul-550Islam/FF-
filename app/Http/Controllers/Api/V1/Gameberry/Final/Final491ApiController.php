...
use App\Services\Gameberry\Final\Final491Service;
use Illuminate\Http\Request;
class Final491ApiController extends Controller
{
    protected Final491Service $service;
    public function __construct(Final491Service $service) { $this->service = $service; }
