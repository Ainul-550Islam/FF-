...
use App\Services\Gameberry\Final\Final497Service;
use Illuminate\Http\Request;
class Final497ApiController extends Controller
{
    protected Final497Service $service;
    public function __construct(Final497Service $service) { $this->service = $service; }
