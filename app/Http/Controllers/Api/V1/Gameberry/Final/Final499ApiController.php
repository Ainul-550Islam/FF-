...
use App\Services\Gameberry\Final\Final499Service;
use Illuminate\Http\Request;
class Final499ApiController extends Controller
{
    protected Final499Service $service;
    public function __construct(Final499Service $service) { $this->service = $service; }
