...
use App\Services\Gameberry\Final\Final498Service;
use Illuminate\Http\Request;
class Final498ApiController extends Controller
{
    protected Final498Service $service;
    public function __construct(Final498Service $service) { $this->service = $service; }
