...
use App\Services\Gameberry\Final\Final493Service;
use Illuminate\Http\Request;
class Final493ApiController extends Controller
{
    protected Final493Service $service;
    public function __construct(Final493Service $service) { $this->service = $service; }
