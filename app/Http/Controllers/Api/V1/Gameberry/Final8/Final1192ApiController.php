...
class Final1192ApiController extends Controller
{
    protected $service;

    public function __construct()
    {
        $serviceClass = 'App\\Services\\Gameberry\\Final8\\Final1157Service';
    ...
    public function play(Request $request)
    {
        ...
        try {
            ...
            return response()->json([
                'success' => false,
                'message' => 'Final1192 play failed: ' . $e->getMessage() . ' - G1 Must Reconcile STOP',
                'feature' => 1192,
            ], 400);
        }
    }
