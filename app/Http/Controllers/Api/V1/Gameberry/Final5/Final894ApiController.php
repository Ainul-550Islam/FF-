...
use App\Services\Gameberry\Final5\Final894Service;
use Illuminate\Http\Request;
class Final894ApiController extends Controller
{
    protected Final894Service $service;
    public function __construct(Final894Service $service) { $this->service = $service; }
