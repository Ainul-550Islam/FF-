...
use App\Services\Gameberry\Final5\Final897Service;
use Illuminate\Http\Request;
class Final897ApiController extends Controller
{
    protected Final897Service $service;
    public function __construct(Final897Service $service) { $this->service = $service; }
