...
use App\Services\Gameberry\Final5\Final900Service;
use Illuminate\Http\Request;
class Final900ApiController extends Controller
{
    protected Final900Service $service;
    public function __construct(Final900Service $service) { $this->service = $service; }
