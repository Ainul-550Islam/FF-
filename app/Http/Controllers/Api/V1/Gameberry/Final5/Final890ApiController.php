...
use App\Services\Gameberry\Final5\Final890Service;
use Illuminate\Http\Request;
class Final890ApiController extends Controller
{
    protected Final890Service $service;
    public function __construct(Final890Service $service) { $this->service = $service; }
