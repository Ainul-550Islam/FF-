...
use App\Services\Gameberry\Final5\Final893Service;
use Illuminate\Http\Request;
class Final893ApiController extends Controller
{
    protected Final893Service $service;
    public function __construct(Final893Service $service) { $this->service = $service; }
