...
use App\Services\Gameberry\Final5\Final899Service;
use Illuminate\Http\Request;
class Final899ApiController extends Controller
{
    protected Final899Service $service;
    public function __construct(Final899Service $service) { $this->service = $service; }
