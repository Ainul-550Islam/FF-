...
use App\Services\Gameberry\Final5\Final898Service;
use Illuminate\Http\Request;
class Final898ApiController extends Controller
{
    protected Final898Service $service;
    public function __construct(Final898Service $service) { $this->service = $service; }
