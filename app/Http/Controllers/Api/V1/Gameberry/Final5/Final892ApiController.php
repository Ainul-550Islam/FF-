...
use App\Services\Gameberry\Final5\Final892Service;
use Illuminate\Http\Request;
class Final892ApiController extends Controller
{
    protected Final892Service $service;
    public function __construct(Final892Service $service) { $this->service = $service; }
