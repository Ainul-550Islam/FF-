...
use App\Services\Gameberry\Final5\Final886Service;
use Illuminate\Http\Request;
class Final886ApiController extends Controller
{
    protected Final886Service $service;
    public function __construct(Final886Service $service) { $this->service = $service; }
