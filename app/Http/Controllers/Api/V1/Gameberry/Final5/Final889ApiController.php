<?php
namespace App\Http\Controllers\Api\V1\Gameberry\Final5;
use App\Http\Controllers\Controller;
use App\Services\Gameberry\Final5\Final889Service;
use Illuminate\Http\Request;
class Final889ApiController extends Controller
{
    protected Final889Service $service;
    public function __construct(Final889Service $service) { $this->service = $service; }
