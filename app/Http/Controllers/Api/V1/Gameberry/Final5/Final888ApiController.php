...
use App\Services\Gameberry\Final5\Final888Service;
use Illuminate\Http\Request;
class Final888ApiController extends Controller
{
    protected Final888Service $service;
    public function __construct(Final888Service $service) { $this->service = $service; }
