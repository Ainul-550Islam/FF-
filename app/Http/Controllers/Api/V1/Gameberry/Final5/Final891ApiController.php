...
use App\Services\Gameberry\Final5\Final891Service;
use Illuminate\Http\Request;
class Final891ApiController extends Controller
{
    protected Final891Service $service;
    public function __construct(Final891Service $service) { $this->service = $service; }
