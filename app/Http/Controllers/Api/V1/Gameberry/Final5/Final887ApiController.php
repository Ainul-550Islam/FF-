...
use App\Services\Gameberry\Final5\Final887Service;
use Illuminate\Http\Request;
class Final887ApiController extends Controller
{
    protected Final887Service $service;
    public function __construct(Final887Service $service) { $this->service = $service; }
