...
use App\Services\Gameberry\Final5\Final895Service;
use Illuminate\Http\Request;
class Final895ApiController extends Controller
{
    protected Final895Service $service;
    public function __construct(Final895Service $service) { $this->service = $service; }
